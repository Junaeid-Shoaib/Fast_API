from pydantic import BaseModel, EmailStr, AnyUrl, constr, Field, field_validator, model_validator
...
#step-2: the data
patient_info = {'name':'john doe', 'age':30, 'weight': 78.0,  'allergies':['pollen', 'dust'], 'contact':{'email': 'aj.sh@gfm.co.uk', 'phone':'00000000000',  "website": "https://example.com" }}
